...
public abstract class AbstractControllerTest {
    ...
    protected static final String TENANT_ADMIN_EMAIL = "testtenant2@thingsboard.org";
    private static final String TENANT_ADMIN_PASSWORD = "tenant";

    protected static final String CUSTOMER_USER_EMAIL = "testcustomer2@thingsboard.org";
