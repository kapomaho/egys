...
public class ModelConstants {
    ...
    /**
     * Cassandra nvr constants.
     */
    public static final String NVR_COLUMN_FAMILY_NAME = "nvr";
    public static final String NVR_TENANT_ID_PROPERTY = TENANT_ID_PROPERTY;
    public static final String NVR_ASSIGNED_CUSTOMERS_PROPERTY = DEVICE_ASSIGNED_CUSTOMERS_PROPERTY;
    public static final String NVR_NAME_PROPERTY = "name";
    public static final String NVR_TYPE_PROPERTY = "type";
    public static final String NVR_ADDITIONAL_INFO_PROPERTY = ADDITIONAL_INFO_PROPERTY;
    public static final String NVR_HOST_PROPERTY = "ip";
    public static final String NVR_PORT_PROPERTY = "port";
    public static final String NVR_BRAND_PROPERTY = "brand";
    public static final String NVR_MODEL_PROPERTY = "model";
    public static final String NVR_USERNAME_PROPERTY = "username";
    public static final String NVR_PASSWORD_PROPERTY = "password";

    public static final String NVR_BY_TENANT_AND_SEARCH_TEXT_COLUMN_FAMILY_NAME = "nvr_by_tenant_and_search_text";
    public static final String NVR_BY_TENANT_BY_TYPE_AND_SEARCH_TEXT_COLUMN_FAMILY_NAME = "nvr_by_tenant_by_type_and_search_text";
    public static final String NVR_BY_CUSTOMER_AND_SEARCH_TEXT_COLUMN_FAMILY_NAME = "nvr_by_customer_and_search_text";
    public static final String NVR_BY_CUSTOMER_BY_TYPE_AND_SEARCH_TEXT_COLUMN_FAMILY_NAME = "nvr_by_customer_by_type_and_search_text";
    public static final String NVR_BY_TENANT_AND_NAME_VIEW_NAME = "nvr_by_tenant_and_name";
    public static final String NVR_BY_TENANT_AND_HOST_VIEW_NAME = "nvr_by_tenant_and_host";
    public static final String NVR_TYPES_BY_TENANT_VIEW_NAME = "nvr_types_by_tenant";


    /**
     * Cassandra camera constants.
     */
    public static final String CAMERA_COLUMN_FAMILY_NAME = "camera";
    public static final String CAMERA_TENANT_ID_PROPERTY = TENANT_ID_PROPERTY;
    public static final String CAMERA_ASSIGNED_CUSTOMERS_PROPERTY = DEVICE_ASSIGNED_CUSTOMERS_PROPERTY;
    public static final String CAMERA_NAME_PROPERTY = "name";
    public static final String CAMERA_TYPE_PROPERTY = "type";
    public static final String CAMERA_ADDITIONAL_INFO_PROPERTY = ADDITIONAL_INFO_PROPERTY;
    public static final String CAMERA_HOST_PROPERTY = "ip";
    public static final String CAMERA_PORT_PROPERTY = "port";
    public static final String CAMERA_PRIMARY_PATH_PROPERTY = "primary_path";
    public static final String CAMERA_SECONDARY_PATH_PROPERTY = "secondary_path";
    public static final String CAMERA_PTZ_PROPERTY = "ptz";
    public static final String CAMERA_BRAND_PROPERTY = "brand";
    public static final String CAMERA_MODEL_PROPERTY = "model";
    public static final String CAMERA_RTSP_AUTH_PROPERTY = "rtsp_auth";
    public static final String CAMERA_USERNAME_PROPERTY = "username";
    public static final String CAMERA_PASSWORD_PROPERTY = "password";
    public static final String CAMERA_CHANNEL_NO_PROPERTY = "channel_no";

    public static final String CAMERA_BY_TENANT_AND_SEARCH_TEXT_COLUMN_FAMILY_NAME = "camera_by_tenant_and_search_text";
    public static final String CAMERA_BY_TENANT_BY_TYPE_AND_SEARCH_TEXT_COLUMN_FAMILY_NAME = "camera_by_tenant_by_type_and_search_text";
    public static final String CAMERA_BY_CUSTOMER_AND_SEARCH_TEXT_COLUMN_FAMILY_NAME = "camera_by_customer_and_search_text";
    public static final String CAMERA_BY_CUSTOMER_BY_TYPE_AND_SEARCH_TEXT_COLUMN_FAMILY_NAME = "camera_by_customer_by_type_and_search_text";
    public static final String CAMERA_BY_TENANT_AND_NAME_VIEW_NAME = "camera_by_tenant_and_name";
    public static final String CAMERA_BY_TENANT_AND_HOST_VIEW_NAME = "camera_by_tenant_and_host";
    public static final String CAMERA_TYPES_BY_TENANT_VIEW_NAME = "camera_types_by_tenant";
