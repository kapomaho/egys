...
public class TenantServiceImpl extends AbstractEntityService implements TenantService {
    ...
    public static final String INCORRECT_TENANT_NAME = "Incorrect tenantName";
    ...
    {
        log.trace("Executing findTenantByName [{}]", tenantName);
        Validator.validateName(tenantName,INCORRECT_TENANT_NAME + tenantName);
        return tenantDao.findByName(tenantName);
    }
