...
CREATE TABLE IF NOT EXISTS camera (
    id varchar(31) NOT NULL CONSTRAINT camera_pkey PRIMARY KEY,
    additional_info varchar,
    assigned_customers varchar(1000000),
    name varchar(255),
    search_text varchar(255),
    ...
    ptz boolean,
    rtsp_auth boolean,
    channel_no varchar(31),
    tenant_id varchar(31),
    type varchar(255)
);

CREATE TABLE IF NOT EXISTS nvr (
    id varchar(31) NOT NULL CONSTRAINT nvr_pkey PRIMARY KEY,
    additional_info varchar,
    assigned_customers varchar(1000000),
    name varchar(255),
    search_text varchar(255),
