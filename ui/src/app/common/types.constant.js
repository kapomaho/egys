    ...
    .constant('types',
        {
            ...
            aliasFilterType: {
                ...
                cameraType: {
                    value: 'cameraType',
                    name: 'alias.filter-type-camera-type'
                },
                nvrType: {
                    value : 'nvrType',
                    name: 'alias.filter-type-nvr-type'
                },
                relationsQuery: {
                ...
                cameraSearchQuery: {
                    ...
                    name: 'alias.filter-type-camera-search-query'
                },
                nvrSearchQuery: {
                    value: 'nvrSearchQuery',
                    name: 'alias.filter-type-nvr-search-query'
                }
            },
            position: {
                top: {
            ...
            entityTypeTranslations: {
                ...
                "CAMERA": {
                    ...
                    typePlural: 'entity.type-cameras',
                    list: 'entity.list-of-cameras',
                    nameStartsWith: 'entity.camera-name-starts-with'
                },
                "NVR": {
                    type: 'entity.type-nvr',
                    typePlural: 'entity.type-nvrs',
                    list: 'entity.list-of-nvrs',
                    nameStartsWith: 'entity.nvr-name-starts-with'
                },
                "TENANT": {
