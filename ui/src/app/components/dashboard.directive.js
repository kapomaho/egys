...
function DashboardController($scope, $rootScope, $element, $timeout, $mdMedia, $mdUtil, $q, timeService, types, utils) {
    ...
    vm.enableWidgetCollapse = enableWidgetCollapse;
    ...
    function enableWidgetCollapse(widget) {
        if (angular.isDefined(widget.config.enableCollapse)) {
            return widget.config.enableCollapse;
        } else {
            return true;
        }
    }
