...
function WidgetConfig($compile, $templateCache, $rootScope, $translate, $timeout, types, utils) {
    ...
    var linker = function (scope, element, attrs, ngModelCtrl) {
        ...
        ngModelCtrl.$render = function () {
            if (ngModelCtrl.$viewValue) {
                ...
                if (config) {
                    ...
                    scope.enableCollapse = angular.isDefined(config.enableCollapse) ? config.enableCollapse : scope.showTitle;
        ...
        scope.$watch('title + showTitle + dropShadow + enableFullscreen + enableCollapse + backgroundColor + color + ' +
            ...
            if (ngModelCtrl.$viewValue) {
                ...
                if (value.config) {
                    ...
                    config.enableCollapse = scope.enableCollapse && scope.showTitle;
