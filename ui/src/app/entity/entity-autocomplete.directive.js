        ...
        function load() {
            switch (scope.entityType) {
                ...
                case types.entityType.camera:
                    scope.selectEntityText = 'camera.select-camera';
                    scope.entityText = 'camera.camera';
                    scope.noEntitiesMatchingText = 'camera.no-cameras-matching';
                    scope.entityRequiredText = 'camera.camera-required';
                    break;
                case types.entityType.nvr:
                    scope.selectEntityText = 'nvr.select-nvr';
                    scope.entityText = 'nvr.nvr';
                    scope.noEntitiesMatchingText = 'nvr.no-nvrs-matching';
                    scope.entityRequiredText = 'nvr.nvr-required';
                    break;
