...
/*@ngInject*/
export default function EntitySubtypeAutocomplete($compile, $templateCache, $q, $filter, assetService, deviceService, cameraService, nvrService, entityViewService, types) {
    ...
    var linker = function (scope, element, attrs, ngModelCtrl) {
        ...
        function load() {
            if (scope.entityType == types.entityType.asset) {
                ...
                scope.selectEntitySubtypeText = 'camera.select-camera-type';
                scope.entitySubtypeText = 'camera.camera-type';
                scope.entitySubtypeRequiredText = 'camera.camera-type-required';
                scope.$on('cameraSaved', function() {
                    scope.entitySubtypes = null;
                });
            } else if (scope.entityType == types.entityType.nvr) {
                scope.selectEntitySubtypeText = 'nvr.select-nvr-type';
                scope.entitySubtypeText = 'nvr.nvr-type';
                scope.entitySubtypeRequiredText = 'nvr.nvr-type-required';
                scope.$on('nvrSaved', function() {
                    scope.entitySubtypes = null;
                });
            } else if (scope.entityType == types.entityType.entityView) {
