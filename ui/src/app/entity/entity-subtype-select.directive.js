...
/*@ngInject*/
export default function EntitySubtypeSelect($compile, $templateCache, $translate, assetService, deviceService, cameraService, nvrService, entityViewService, types) {
    ...
    var linker = function (scope, element, attrs, ngModelCtrl) {
        ...
        function load() {
            if (scope.entityType == types.entityType.asset) {
                ...
                scope.entitySubtypeTitle = 'camera.camera-type';
                scope.entitySubtypeRequiredText = 'camera.camera-type-required';
            } else if (scope.entityType == types.entityType.nvr) {
                scope.entitySubtypeTitle = 'nvr.nvr-type';
