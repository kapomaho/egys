...
import logoSvg from '../../svg/hvl_iot_logo.svg';
...
/*@ngInject*/
export default function HomeController(types, loginService, userService, deviceService, cameraService, Fullscreen, $scope, $element, $rootScope, $document, $state,
