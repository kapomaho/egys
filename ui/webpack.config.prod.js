...
module.exports = {
    ...
    plugins: [
        ...
        new CopyWebpackPlugin([
            ...
            {from: './src/widget.utils.js', to: 'widget.utils.js'},
            {from: './src/widget.user.service.js', to: 'widget.user.service.js'},
            {from: './src/widget.camera.service.js', to: 'widget.camera.service.js'},
            {from: './src/widget.customer.service.js', to: 'widget.customer.service.js'},
            {from: './src/widget.nvr.service.js', to: 'widget.nvr.service.js'}
        ]),
